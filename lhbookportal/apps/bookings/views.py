...
from .mails import send_booking_details_to_admin, send_approval_email,send_email_in_background,send_rejection_mail_to_user, send_confirmation_mail, send_approved_mail_to_user,send_rejected_mail_to_user
